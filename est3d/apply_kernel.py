...
def get_kpts():
    ...
    file_path_0 = f'D:/Programming/Programs_Py/est3d/MotionBERT/file_{file_number}_pred0_2/X3D.npy'
    kpts0 = np.load(file_path_0)
    
    file_path_1 = f'D:/Programming/Programs_Py/est3d/MotionBERT/file_{file_number}_pred1_2/X3D.npy'
    if not os.path.exists(file_path_1):
        kpts1 = None
    else:
        kpts1 = np.load(file_path_1)
    
    file_path_2 = f'D:/Programming/Programs_Py/est3d/MotionBERT/file_{file_number}_pred2_2/X3D.npy'
