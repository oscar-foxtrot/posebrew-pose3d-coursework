...
def evaluate_candidate_focals(
    ...
    best_val = np.inf
    best = None
    best_cheirality = x1_all.shape[0] * x1_all.shape[1]
    ...
    for R, t in candidates:
        ...
        if missing <= best_cheirality and loss < best_val:
            best_cheirality = missing
            best_val = loss
            best = {
                "f1": f1,
                "f2": f2,
...
print(res['f1'], res['f2'], res['R'], res['t'], res['loss'])
